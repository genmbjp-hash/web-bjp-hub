...
import { DEFAULT_SITE_SETTINGS } from '../utils/storage';
import {
  FileText,
  Printer,
  Download,
...
Terverifikasi Sistem BJP HUB RW 11
  ...
  return (
    <div className="max-w-6xl mx-auto my-8 px-4 sm:px-6 space-y-8">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-emerald-900 via-emerald-800 to-stone-900 text-white p-6 sm:p-8 rounded-3xl shadow-lg border border-emerald-700/50 flex items-center justify-between flex-wrap gap-4 no-print">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-emerald-200">• Otomatis & Terverifikasi</span>
          </div>
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight flex items-center gap-2">
            <FileText className="w-7 h-7 text-amber-300" />
            <span>Generator Surat Menyurat Online BJP HUB</span>
          </h1>
