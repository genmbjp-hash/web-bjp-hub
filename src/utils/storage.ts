...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  socialFeeds: [
    // Section 1: Slide Konten Terbaru
    {
      id: 'feed-1',
      title: '🎥 Liputan Gotong Royong & Inovasi Lingkungan Asri RW 11',
      description: 'Video update aksi kebersihan warga, pemilahan sampah mandiri, dan penghijauan fasos fasum Komplek Bintara Jaya Permai.',
    ...
    {
      id: 'feed-2',
      title: '✨ Reels Semarak Bazar UMKM & Wisata Kuliner BJP (@bintarajayapermai.ofc)',
      description: 'Cuplikan promo jajanan khas, produk kreatif, dan menu favorit warga binaan Sentra Usaha Bintara Jaya Permai.',
      url: 'https://www.instagram.com/reel/C3_bjp_umkm/',
      platform: 'instagram',
      section: 'terbaru',
      enabled: true,
      order: 1,
    ...
    {
      id: 'feed-3',
      title: '📸 Potret Kebersamaan Senam Sehat & Posyandu Lansia RW 11',
      description: 'Dokumentasi foto kegiatan rutin kebugaran jasmani dan pemeriksaan kesehatan gratis bagi warga di Balai Warga BJP.',
      url: 'https://www.instagram.com/p/C3_bjp_posyandu/',
      platform: 'instagram',
      section: 'terbaru',
      enabled: true,
      order: 2,
    ...
    {
      id: 'feed-4',
      title: '🏆 Video Semarak Peringatan HUT RI & Turnamen Olahraga Warga',
      description: 'Kemeriahan pertandingan bulutangkis, tenis meja, dan pesta lomba anak-anak seluruh keluarga besar Bintara Jaya Permai.',
    ...
    {
      id: 'feed-5',
      title: '🌿 Galeri Foto Penataan Taman & Area Santai Gazebo Balai Warga',
      description: 'Potret hasil pengerjaan renovasi ruang terbuka hijau dan pojok baca ruang publik ramah anak Komplek BJP.',
      url: 'https://www.instagram.com/p/C3_bjp_taman/',
      platform: 'instagram',
      section: 'terbaru',
      enabled: true,
      order: 4,
    ...
    // Section 2: Album Foto BJP
    {
      id: 'photo-1',
      title: '📸 Album Foto Aksi Gotong Royong & Penghijauan Lingkungan',
      description: 'Galeri foto kebersamaan warga RT 01-09 dalam kerja bakti masal dan penataan taman asri Komplek BJP.',
      url: 'https://www.instagram.com/p/C3_bjp_gotongroyong/',
      platform: 'instagram',
      section: 'album_foto',
      enabled: true,
      order: 0,
    ...
    {
      id: 'photo-2',
      title: '🛍️ Galeri Foto Bazar UMKM Kuliner & Kerajinan Tangan BJP HUB',
      description: 'Kumpulan momen keseruan bazar malam minggu, pameran produk kreatif, dan ragam kuliner lezat warga RW 11.',
      url: 'https://www.instagram.com/p/C3_bjp_bazar/',
      platform: 'instagram',
      section: 'album_foto',
      enabled: true,
      order: 1,
    ...
    {
      id: 'photo-3',
      title: '🩺 Album Potret Layanan Posyandu Lansia & Balita Sehat BJP',
      description: 'Foto dokumentasi pemeriksaan kesehatan rutin, penimbangan balita, dan pembagian makanan tambahan bergizi.',
      url: 'https://www.instagram.com/p/C3_bjp_posyandu_foto/',
      platform: 'instagram',
      section: 'album_foto',
      enabled: true,
      order: 2,
    ...
    {
      id: 'photo-4',
      title: '🎉 Dokumentasi Foto Perlombaan Kemerdekaan & Fun Match Warga',
      description: 'Potret riang anak-anak dan keakraban bapak-ibu dalam berbagai lomba peringatan HUT Republik Indonesia.',
      url: 'https://www.instagram.com/p/C3_bjp_hutri/',
      platform: 'instagram',
      section: 'album_foto',
      enabled: true,
      order: 3,
    ...
    {
      id: 'photo-5',
      title: '🕌 Album Foto Peringatan Hari Besar Keagamaan Masjid Al-Aqwam BJP',
      description: 'Dokumentasi momen kekhusyukan dan silaturahmi jamaah masjid dalam kegiatan pengajian dan bakti sosial.',
      url: 'https://www.instagram.com/p/C3_bjp_masjid/',
      platform: 'instagram',
      section: 'album_foto',
      enabled: true,
      order: 4,
    ...
    // Section 3: Album Video BJP
    {
      id: 'video-1',
      title: '🎥 Video Dokumenter Profil & Fasilitas Publik Bintara Jaya Permai',
      description: 'Tayangan video lengkap gambaran fasilitas Balai Warga, lapangan olahraga, gazebo, dan suasana lingkungan RW 11.',
      url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
      platform: 'youtube',
      section: 'album_video',
      enabled: true,
    ...
    {
      id: 'video-2',
      title: '🎥 Video Highlight Turnamen Bulutangkis & Tenis Meja Antar-RT',
      description: 'Cuplikan video smash spektakuler dan keseruan final turnamen olahraga warga Komplek BJP.',
      url: 'https://www.youtube.com/watch?v=L_LUpnjgPso',
      platform: 'youtube',
      section: 'album_video',
      enabled: true,
    ...
    {
      id: 'video-3',
      title: '🎥 Video Reels Pentas Seni & Kreativitas Pemuda Karang Taruna',
      description: 'Aksi panggung lagu daerah, tarian modern, dan penampilan grup musik pemuda Bintara Jaya Permai.',
      url: 'https://www.instagram.com/reel/C3_bjp_pensi/',
      platform: 'instagram',
      section: 'album_video',
      enabled: true,
      order: 2,
    ...
    {
      id: 'video-4',
      title: '🎥 Liputan Video Profil Usaha Binaan Sentra UMKM Kuliner BJP',
      description: 'Wawancara singkat dan proses pembuatan produk jajanan khas warga binaan Sentra Usaha BJP HUB.',
    ...
    {
      id: 'video-5',
      title: '🎥 Video Liputan Senam Sehat & Senam Aerobik Bersama Warga',
      description: 'Gerakan energik instruktur dan semangat warga menjaga kebugaran jasmani setiap akhir pekan.',
      url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
      platform: 'youtube',
      section: 'album_video',
      enabled: true,
  ...
  try {
    ...
    if (data) {
      ...
      return {
        ...
        socialFeeds:
          Array.isArray(parsed.socialFeeds) && parsed.socialFeeds.length >= 5
            ? parsed.socialFeeds
            : DEFAULT_SITE_SETTINGS.socialFeeds,
        mediaPartners:
          Array.isArray(parsed.mediaPartners) && parsed.mediaPartners.length > 0
            ? parsed.mediaPartners
